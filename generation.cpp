...
void Generation::SpawnDoors(int verticalShift, int horizontalShift){
    POS p;
...
void Generation::SpawnHouse(const int& minWidth, const int& maxWidth, const int& minHeight, const int& maxHeight, const POS& pos){
    POS spawn;
    int width = 0;
    int height = 0;
    int y = 0;
